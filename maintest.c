...
*/
    ...
    printf("\033[1;32mTest 17 => \033[0m|%lx|\n", -9223372036854775806);
 	  ft_printf("\033[1;31mTest 17 => \033[0m|%lx|\n", -9223372036854775806);

	       printf("\033[1;32mTest 18 => \033[0m|%lx|\n", -92233720368547);
 	  ft_printf("\033[1;31mTest 18 => \033[0m|%lx|\n",   -92233720368547);

	       printf("\033[1;32mTest 19 => \033[0m|%x|\n", -5806);
 	  ft_printf("\033[1;31mTest 19 => \033[0m|%x|\n",   -5806);

	       printf("\033[1;32mTest 20 => \033[0m|%x|\n", -806);
 	  ft_printf("\033[1;31mTest 20 => \033[0m|%x|\n",   -806);

	       printf("\033[1;32mTest 21 => \033[0m|%lx|\n", -924924775775);
 	  ft_printf("\033[1;31mTest 21 => \033[0m|%lx|\n",   -924924775775);

	       printf("\033[1;32mTest 22 => \033[0m|%lx|\n", -9999999999999);
 	  ft_printf("\033[1;31mTest 22 => \033[0m|%lx|\n",   -9999999999999);

	       printf("\033[1;32mTest 23 => \033[0m|%x|\n", -92);
 	  ft_printf("\033[1;31mTest 23 => \033[0m|%x|\n",   -92);

	       printf("\033[1;32mTest 24 => \033[0m|%x|\n", -9);
 	  ft_printf("\033[1;31mTest 24 => \033[0m|%x|\n",   -9);

	       printf("\033[1;32mTest 25 => \033[0m|%x|\n", -9775806);
 	  ft_printf("\033[1;31mTest 25 => \033[0m|%x|\n",   -9775806);

	       printf("\033[1;32mTest 26 => \033[0m|%lx|\n", -92233720854775806);
 	  ft_printf("\033[1;31mTest 26 => \033[0m|%lx|\n",   -92233720854775806);

	       printf("\033[1;32mTest 27 => \033[0m|%lx|\n", -9272036854775806);
 	  ft_printf("\033[1;31mTest 27 => \033[0m|%lx|\n",   -9272036854775806);

	       printf("\033[1;32mTest 28 => \033[0m|%x|\n", -92878787);
 	  ft_printf("\033[1;31mTest 28 => \033[0m|%x|\n",   -92878787);

	       printf("\033[1;32mTest 29 => \033[0m|%lx|\n", -9876543210);
 	  ft_printf("\033[1;31mTest 29 => \033[0m|%lx|\n",   -9876543210);

	       printf("\033[1;32mTest 30 => \033[0m|%x|\n", -36854);
 	  ft_printf("\033[1;31mTest 30 => \033[0m|%x|\n",   -36854);

	       printf("\033[1;32mTest 31 => \033[0m|%x|\n", -9212);
 	  ft_printf("\033[1;31mTest 31 => \033[0m|%x|\n",   -9212);

	       printf("\033[1;32mTest 32 => \033[0m|%x|\n", -15);
 	  ft_printf("\033[1;31mTest 32 => \033[0m|%x|\n",   -15);
...
printf("\033[1;41m|-----------------------| (Lancement du test OCTAL en cours...) |-----------------------|\033[0m\n");
	...
	printf("{%d}\n", printf("\033[1;32mTest 28 => \033[0m|%-.u|", (unsigned int)42));
	ft_printf("{%d}\n", ft_printf("\033[1;31mTest 28 => \033[0m|%-.u|", (unsigned int)42));
